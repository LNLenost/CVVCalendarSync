...
def get_periods(student_id, z_auth_token, z_token):
	...
	headers = {
		...
		"Referer": "https://web.spaggiari.eu/home/app/default/menu_personale.php",
	...
	if response.status_code == 200:
		...
		try:
			...
			if (
				error_json.get("statusCode") == 422 and
...
def cli():
    ...
    if not os.path.exists(config_file):
        ...
        print("   👉 https://github.com/LNLenost/CVVCalendarSync#%EF%B8%8F-configurazione")
    ...
    if not os.path.exists(credentials_file):
        ...
        print("   👉 https://github.com/LNLenost/CVVCalendarSync#2-scarica-credentialsjson")
        sys.exit(1)
